...
if [ ! -d asterisk-g72x_100 ]; then
	...
	wget --directory-prefix=asterisk-g72x_100 \
		...
		http://asterisk.hosting.lv/bin/codec_g723-ast100-gcc4-glibc-core2.so \
		http://asterisk.hosting.lv/bin/codec_g723-ast100-gcc4-glibc-core2-sse4.so \
		...
		http://asterisk.hosting.lv/bin/codec_g729-ast100-gcc4-glibc-core2.so \
		http://asterisk.hosting.lv/bin/codec_g729-ast100-gcc4-glibc-core2-sse4.so \
